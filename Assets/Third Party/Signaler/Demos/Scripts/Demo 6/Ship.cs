namespace echo17.Signaler.Demos.Demo6
{
    ...
    public class Ship : MonoBehaviour, IBroadcaster, ISubscriber, IFriendly
    {
        ...
        void Awake()
        {
            ...
            Signaler.Instance.Subscribe<GetShipGunRequest, GetShipGunResponse>(this, OnGetShipGunRequest);
        ...
        private void Kill()
        {
            ...
            // This demo script shows how you can directly unsubscribe without having to cache a reference to the subscription
            Signaler.Instance.UnSubscribe<InputSignal>(this, OnInputSignal);
            Signaler.Instance.UnSubscribe<GetShipGunRequest, GetShipGunResponse>(this, OnGetShipGunRequest);
            Signaler.Instance.UnSubscribe<AsteroidHitFriendlySignal>(this, OnAsteroidHitFriendlySignal);
            Signaler.Instance.UnSubscribe<GameOverSignal>(this, OnGameOverSignal);
